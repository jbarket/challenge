...
can easily bring the whole suite back up on a new instance. If we're persisting actor state, we should
be able to even restore their location, number of trips, et cetera in that case.
...
own actor that can manage all of the information about a given elevator. It can make determiantions about 
when it should be serviced based on a variety of factors without cluttering up the Elevator itself.